...
return [
    ...
    "view" => [
        ...
        "data" => [
            ...
            "favicon"       => "img/dragon1.png",//"img/favicon/favicon_256x256.png",
    ...
    "views" => [
        [
            ...
            "data" => [
                "class" => "logo-1",
                "src" => "img/dragon1.png",//"img/favicon/favicon_128x128.png",
                "alt" => "Logo",
            ],
            "sort" => 1
        ],
        [
            ...
            "data" => [
                ...
                "siteLogoTextIcon" => "img/dragon1.png",//"img/favicon/favicon_40x40.png", (AF)
